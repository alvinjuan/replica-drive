...
export default function UpdateProfile() {
    ...
    const { currentUser } = useAuth() // pulling from authcontext.js
                ...
                <Card.Body>
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group id="password-confirm" className="mb-3">
                            ...
                            <Form.Control type="password" ref={passwordConfirmRef} required placeholder="Leave blank to keep the same"/>{/* the actual input form */}
                        </Form.Group>
